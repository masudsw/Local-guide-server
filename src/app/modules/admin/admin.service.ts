...
const softDeleteFromDB = async (id: string): Promise<Admin | null> => {
    ...
    const result = await prisma.$transaction(async (trasactionClient) => {
        const adminDeletedData = await trasactionClient.admin.update({
            where: {
                id
            },
            data: {
        ...
        await trasactionClient.user.update({
            where: {
                email: adminDeletedData.email
            },
            data: {
